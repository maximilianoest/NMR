...
data = load('C:\Users\maxoe\Google Drive\Promotion\Results\DOPS\SERVER_DOPS_LIPIDS_H_250ns_1ps_resultsCorrelationFunctions.mat');
meanData = data.meanCorrelation;
normData = data.normCorrelation;


figure('Name','Normalized Correlation Functions')
