...
data = load('C:\Users\maxoe\Google Drive\Promotion\Results\DOPS\DOPS_allData_CorrelationFunction.mat');
meanData = data.meanCorrelation;
normData = data.normCorrelation;


figure('Name','Normalized Correlation Functions DOPS')
...
title('Normalized Correlation Functions DOPS')