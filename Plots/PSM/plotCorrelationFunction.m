...
data = load('C:\Users\maxoe\Google Drive\Promotion\Results\PSM\PSM_allData_CorrelationFunction.mat');
meanData = data.meanCorrelation;
normData = data.normCorrelation;


figure('Name','Normalized Correlation Functions PSM')
...
title('Normalized Correlation Functions PSM')