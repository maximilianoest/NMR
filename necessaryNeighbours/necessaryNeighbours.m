...
sumCorrelationFunction0W0Saver = zeros(fibreOrientationsCount ...
    ,positionsInMyelinCount,size(trajectoryX,2),'like',single(1j));
sumCorrelationFunction1W0Saver = zeros(fibreOrientationsCount ...
    ,positionsInMyelinCount,size(trajectoryX,2),'like',single(1j));
sumCorrelationFunction2W0Saver = zeros(fibreOrientationsCount ...
    ,positionsInMyelinCount,size(trajectoryX,2),'like',single(1j));
...
allCorrelationFunction0W0Saver = zeros(atomsToCalculate,fibreOrientationsCount ...
    ,positionsInMyelinCount,size(trajectoryX,2),'like',single(1j));
allCorrelationFunction1W0Saver = zeros(atomsToCalculate,fibreOrientationsCount ...
    ,positionsInMyelinCount,size(trajectoryX,2),'like',single(1j));
allCorrelationFunction2W0Saver = zeros(atomsToCalculate,fibreOrientationsCount ...
    ,positionsInMyelinCount,size(trajectoryX,2),'like',single(1j));
...
% rotatedX = zeros(nearestNeighboursX,timeSteps,'single');
% rotatedY = zeros(nearestNeighboursY,timeSteps,'single');
% rotatedZ = zeros(nearestNeighboursZ,timeSteps,'single');
...
%                 ,path2LogFile,false);
            ...
            for caseCounter = 1:length(nearestNeighbourCases)
                ...
                corrFuncLength = length(reducedCorrelationFunction1W0);
                reducedCorrelationFunction1W0 =  ...
                    reducedCorrelationFunction1W0 - mean( ...
                    reducedCorrelationFunction1W0(round( ...
                    offsetSuppressionFraction*corrFuncLength) ...
                    :corrFuncLength));
                reducedCorrelationFunction2W0 = sum( ...
                    correlationFunction2W0( ...
                    1:nearestNeighboursReduction,:),1);
                reducedCorrelationFunction2W0 = ...
                    reducedCorrelationFunction2W0 - mean( ...
                    reducedCorrelationFunction2W0(round( ...
                    offsetSuppressionFraction*corrFuncLength) ...
                    :corrFuncLength));
                if caseCounter == 1
                    ...
                    reducedCorrelationFunction0W0 = ...
                        reducedCorrelationFunction0W0 - ...
                        mean(reducedCorrelationFunction0W0( ...
                        round(offsetSuppressionFraction*corrFuncLength) ...
                        :corrFuncLength));
                    sumCorrelationFunction0W0Saver(orientationNumber ...
                        ,positionNumber,:) = squeeze( ...
                        sumCorrelationFunction0W0Saver(orientationNumber ...
                        ,positionNumber,:))'+reducedCorrelationFunction0W0;
                    sumCorrelationFunction1W0Saver(orientationNumber ...
                        ,positionNumber,:) = squeeze( ...
                        sumCorrelationFunction1W0Saver(orientationNumber ...
                        ,positionNumber,:))'+reducedCorrelationFunction1W0;
                    sumCorrelationFunction2W0Saver(orientationNumber ...
                        ,positionNumber,:) = squeeze( ...
                        sumCorrelationFunction2W0Saver(orientationNumber ...
                        ,positionNumber,:))'+reducedCorrelationFunction2W0;
                    ...
                    allCorrelationFunction0W0Saver(atomCounter ...
                        ,orientationNumber,positionNumber,:) = reducedCorrelationFunction0W0;
                    allCorrelationFunction1W0Saver(atomCounter ...
                        ,orientationNumber,positionNumber,:) = reducedCorrelationFunction1W0;
                    allCorrelationFunction2W0Saver(atomCounter ...
                        ,orientationNumber,positionNumber,:) = reducedCorrelationFunction2W0;
                end
