...
%                 ,path2LogFile,false);
            ...
            for caseCounter = 1:length(nearestNeighbourCases)
                ...
                [spectralDensityW0,spectralDensity2W0] = ...
                    ...
                    ,reducedCorrelationFunction2W0,omega0,samplingFrequency,lags);
...
%             ,path2LogFile,false);
    ...
    logMessage(sprintf([' ---> Average time for one atom: %.3f min \n' ...
        '      Average time for one position/orientation: %.3f min \n'...
        '      Ready in approximately %.3f h.'] ...
        ,mean(atomTimer)/60,mean(atomTimer)/60/calculationSteps ...
        ,mean(atomTimer)*(atomsToCalculate-atomCounter)/60/60) ...
        ,path2LogFile,false);
