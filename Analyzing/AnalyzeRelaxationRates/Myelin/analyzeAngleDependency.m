...
addpath(genpath('C:\Users\maxoe\Google Drive\Promotion\Code\library\'));
...
path2Save = ['C:\Users\maxoe\Google Drive\Promotion\Results\Myelin' ...
    '\Relaxation\RelaxationRatesOfLipidAt' num2str(B0WithoutComma) ...
    'T.fig'];
...
percentile = [5 95];
trimmedCalculatedR1Rates = trimmR1DataWithPercentile(calculatedR1Rates, ...
    percentile);
